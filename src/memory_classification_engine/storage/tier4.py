...
class KnowledgeGraph:
    ...
    def __init__(self, storage_path: str = "./data/tier4"):
        ...
        # Comment in Chinese removed
        self.nodes = {}  # Comment in Chinese removed
        self.edges = defaultdict(list)  # Comment in Chinese removedight)
...
class Tier4Storage:
    ...
    def _init_db(self):
        ...
        try:
            ...
            # Comment in Chinese removedr sorting
    ...
    def store_memory(self, memory: Dict[str, Any], entities: Optional[List[Dict[str, Any]]] = None) -> bool:
        ...
        try:
            ...
            # Comment in Chinese removedrrors
            max_retries = 3
            for retry in range(max_retries):
                try:
                    ...
                    if 'database is locked' in str(e) and retry < max_retries - 1:
                        ...
                        self.connection_pool.return_connection(conn)
                        import time
                        time.sleep(0.5)  # Comment in Chinese removedtrying
                    else:
                        raise
        ...
        try:
            ...
            if entities:
                for entity in entities:
                    ...
                    # Comment in Chinese removedntity
            ...
            # Comment in Chinese removed个记忆保存一次，而不是每次都保存
            # 这里使用一个简单的计数器来控制保存频率
