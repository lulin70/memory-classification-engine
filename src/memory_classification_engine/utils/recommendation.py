...
class RecommendationSystem:
    ...
    def __init__(self, storage_path: str = "./data/recommendations"):
        ...
        self.relevance_weight = 0.4  # Comment in Chinese removed
        self.diversity_weight = 0.3   # Comment in Chinese removed
        self.novelty_weight = 0.3     # Comment in Chinese removed
        self.behavior_decay = 0.9     # Comment in Chinese removedvior
